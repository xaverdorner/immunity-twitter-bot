...
def data_preparator(data_frame):
    ...
    # date at which herd immunity is achieved
    ...
    if not target_date.day == 31:
        ...
        month_ranges = [range((third*month_third), (third + 1) * (month_third)) for third in range(3)]
        ...
        # writing a string for the last day of the month
        target_third = 'end of '
